...
|苏州服务器|label,unlabel,test:1040,2605,1563(tag频率<200,split:0.2,0.7,未加title_ids)|Bert微调+多注意力+GAN(对抗指标：噪音样本与标签w近似度的和)|epoch:50,epoch_step:20;batch-size:4;optimizer:SGD;learning-rate:G0.001,D0.1,B0.001|58.86|
...
|---|---|---|---|---|
|苏州服务器|label,unlabel,test:,0,(split:0.05,0.9,未加title_ids)|Bert微调+多注意力|epoch:50,epoch_step:20;batch-size:4;optimizer:SGD;learning-rate:G0.001,D0.01,B0.1|65.03|
