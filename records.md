...
|苏州服务器|label,unlabel,test:3645,0,1563(tag频率<200,split:0.7,未加title_ids)|Bert微调+多注意力|epoch:50,epoch_step:20;batch-size:4;optimizer:SGD;learning-rate:G0.001,D0.01,B0.1||
|---|---|---|---|---|
